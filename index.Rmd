...
-   For non-rookie running backs, the **random forest model** performed the best, with an error of +/- 63.5 fantasy points. 

-   For rookie running backs, the **linear regression model** performed the best, with an error of +/- 54.4 fantasy points.
...
Here, I create an output of the top 30 projected half-PPR non-rookie running backs from the average of the 4 models. Austin Ekeler, Christian McCaffrey, and Saquon Barkley lead the pack with over 200+ projected fantasy points. These 3 are all projected to go early in the first round of fantasy drafts - and rightfully so. 

Some names that pop out to me are Joe Mixon, who is projected 6th highest in terms of points yet has an ADP 2 rounds later than the other players around him. 

James Conner has an ADP in the 7th round, while the players being drafted around him with similar projected fantasy points are being taken in the 4th round. 

Lastly, Antonio Gibson has a very high ADP in the 12th round; however, other players with similarly projected fantasy points are being taken in the 5th to 8th rounds. 
